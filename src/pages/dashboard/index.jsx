      ...
      <div x-data="setup()">
        <div className="min-h-screen  flex flex-col flex-auto flex-shrink-0 antialiased">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-[#1d1836] w-full shadow-lg rounded">
              <div className="rounded-t mb-0 px-0 border-0">
                ...
                <div className="block w-full">
                  <div className="px-4 bg-[#282535] text-gray-500 dark:text-gray-100 align-middle border border-solid border-gray-200 dark:border-gray-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                    Today
                  </div>
                  <ul className="my-1">
