...
//                 <Heading text="Learn Leap" styles=" pb-2" />
...
const Footer = () => {
  return (
    <footer class="flex flex-col items-center bg-gray-100 text-center">
      <div class="container px-6 pt-6">
        <div class="mb-6 flex justify-center">
          <a
            href="#!"
            type="button"
            class="m-1 h-9 w-9 rounded-full border-2 border-gray-600 uppercase leading-normal transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
            data-te-ripple-init
          ...
          <form action="">
            <div class="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
              ...
              <div class="relative md:mb-6" data-te-input-wrapper-init>
                <input
                  type="text"
                  class="peer block min-h-[auto] w-full rounded border border-gray-400 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                  id="exampleFormControlInput1"
                  placeholder="Email address"
                />
                <label
                  for="exampleFormControlInput1"
                  class="pointer-events-none bg-gray-100 rounded-full px-2 pt-0 py-[2px] absolute left-3 top-1 mb-0 max-w-[90%] origin-[0_0] truncate leading-[1.6] transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none"
                >
                  Email address
                </label>
              </div>
              ...
              <div class="mb-6 md:mr-auto">
                <button
                  // type="submit"
                  class="inline-block rounded border border-gray-400 px-6 py-[9px] text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out hover:scale-x-105"
                  data-te-ripple-init
                  data-te-ripple-color="light"
                >
                  Subscribe
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4">
          <div class="mb-6">
            ...
            <ul class="mb-0 list-none text-blue-800">
              <li className="mb-1">
              ...
              <li className="mb-1">
                <Link className="hover:underline" href="/random-question">
                  Random Questions
                </Link>
              </li>
            </ul>
          ...
          <div class="mb-6">
            ...
            <ul class="text-blue-800 mb-0 list-none">
              <li className="mb-1">
                <Link className="hover:underline" href="discussion">
                  Discuss
                </Link>
              </li>
              <li className="mb-1">
                <Link className="hover:underline" href="/be-a-premium-user">
                  Be a premium user
                </Link>
              </li>
              <li className="mb-1">
          ...
          <div class="mb-6">
            ...
            <ul class="text-blue-800 mb-0 list-none">
              ...
              <li className="mb-1">
                <Link className="hover:underline" href="/dashboard/my-profile">
                  My Profile
                </Link>
              </li>
              <li className="mb-1">
                <Link className="hover:underline" href="/dashboard/results">
                  My Results
                </Link>
              </li>
              <li className="mb-1">
